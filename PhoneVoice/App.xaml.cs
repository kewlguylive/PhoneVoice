...
namespace VoiceQuiz
{
    public partial class App : Application
    {
        ...
        public App()
        {
           ...
           // ParseClient.Initialize("cWnS1e0anjHkgzs04yPHhFAQNTMllWFNbu7BUkQx", "oUiFbM3b4j34Bx5zINtWvPDUb2gek7QV13Ec2DIy");
       ...
       private async Task<bool> DoesFileExistAsync(string fileName)
       {
        ...
        private async Task CopyDatabase()
        {
            ...
            try
            {
                StorageFile storageFile = await ApplicationData.Current.LocalFolder.GetFileAsync("VoiceDB.sqlite");
            ...
            {
                StorageFile databaseFile = await Package.Current.InstalledLocation.GetFileAsync("VoiceDB.sqlite");
                await databaseFile.CopyAsync(ApplicationData.Current.LocalFolder);
            }
        }
